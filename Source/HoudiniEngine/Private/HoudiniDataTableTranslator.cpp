...
namespace
{
		...
		const FString& AttribName)
	{
		...
		else if (FStructProperty* StructProp = CastField<FStructProperty>(Prop))
		{
			...
			// Tuple of doubles
			else if (StructName == NAME_Vector4 || StructName == NAME_Vector || StructName == NAME_Vector2D)
			{
				WriteAttributeDataToStruct<T, float, FFloatProperty>(AttrData,
					Offset,
					RowSize,
...
const TMap<HAPI_StorageType, TArray<UScriptStruct*>> FHoudiniDataTableTranslator::VECTOR_STRUCTS = {
		{HAPI_STORAGETYPE_INT, { nullptr, TBaseStructure<FVector2D>::Get(), TBaseStructure<FVector>::Get(), TBaseStructure<FVector4>::Get() }},
		{HAPI_STORAGETYPE_INT64, { nullptr, TBaseStructure<FVector2D>::Get(), TBaseStructure<FVector>::Get(), TBaseStructure<FVector4>::Get() }},
		{HAPI_STORAGETYPE_FLOAT, { nullptr, TBaseStructure<FVector2D>::Get(), TBaseStructure<FVector>::Get(), TBaseStructure<FVector4>::Get() }},
		{HAPI_STORAGETYPE_FLOAT64, { nullptr, TBaseStructure<FVector2D>::Get(), TBaseStructure<FVector>::Get(), TBaseStructure<FVector4>::Get() }},
		// cannot have tuple of strings
		{HAPI_STORAGETYPE_STRING, { nullptr }},
		{HAPI_STORAGETYPE_UINT8, { nullptr, TBaseStructure<FVector2D>::Get(), TBaseStructure<FVector>::Get(), TBaseStructure<FVector4>::Get() }},
		{HAPI_STORAGETYPE_INT8, { nullptr, TBaseStructure<FVector2D>::Get(), TBaseStructure<FVector>::Get(), TBaseStructure<FVector4>::Get() }},
		{HAPI_STORAGETYPE_INT16, { nullptr, TBaseStructure<FVector2D>::Get(), TBaseStructure<FVector>::Get(), TBaseStructure<FVector4>::Get() }}
};
	...
	const FProperty* Prop)
{
	...
	{
		return Name == NAME_Vector4 ||
			Name == NAME_LinearColor ||
			Name == NAME_Color ||
			Name == NAME_Transform;
	}
	return false;
