...
class FHoudiniTaskInstantiateAsset : public FRunnable
{
public:

	FHoudiniTaskInstantiateAsset(IHoudiniTaskInstantiateAssetCallback* InHoudiniTaskInstantiateAssetCallback, UHoudiniAssetInstance* InHoudiniAssetInstance);
	virtual ~FHoudiniTaskInstantiateAsset();
...
protected:
	...
	IHoudiniTaskInstantiateAssetCallback* HoudiniTaskInstantiateAssetCallback;
