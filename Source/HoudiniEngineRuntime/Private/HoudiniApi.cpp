...
FHoudiniApi::SetEnvFilesFuncPtr
FHoudiniApi::SetEnvFiles = &FHoudiniApi::SetEnvFilesEmptyStub;
...
FHoudiniApi::InitializeHAPI(void* LibraryHandle)
{
	...
	FHoudiniApi::SetEnvFiles = (SetEnvFilesFuncPtr) FPlatformProcess::GetDllExport(LibraryHandle, TEXT("HAPI_SetEnvFiles"));
...
HAPI_Result
FHoudiniApi::SetEnvFilesEmptyStub(const HAPI_Session * session, const char * houdini_environment_files)
{
	return HAPI_RESULT_FAILURE;
}
